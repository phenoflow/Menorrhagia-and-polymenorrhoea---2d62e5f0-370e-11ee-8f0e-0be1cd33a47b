...
steps:
  ...
  menorrhagia-and-polymenorrhoea-cycle---secondary:
    run: menorrhagia-and-polymenorrhoea-cycle---secondary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  menorrhagia-and-polymenorrhoea-menstruation---secondary:
    run: menorrhagia-and-polymenorrhoea-menstruation---secondary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: menorrhagia-and-polymenorrhoea-cycle---secondary/output
  excessive-menorrhagia-and-polymenorrhoea---secondary:
    run: excessive-menorrhagia-and-polymenorrhoea---secondary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: menorrhagia-and-polymenorrhoea-menstruation---secondary/output
  output-cases:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: excessive-menorrhagia-and-polymenorrhoea---secondary/output
class: Workflow
inputs:
  inputModule1:
    id: inputModule1
